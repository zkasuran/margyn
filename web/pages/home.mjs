...
<section class="hero"><div class="wrap">
  ...
  <div class="run">
    <code id="cmd">npx margyn /path/to/repo</code>
...
<pre tabindex="0" role="group" aria-label="Margyn as a GitHub Actions step">- run: npx margyn .</pre>
...
<section><div class="wrap">
  ...
  <div class="run">
    <code id="cmd-end">npx margyn /path/to/repo</code>
