...
<section class="phead"><div class="wrap">
  ...
  <p class="lede prose">Last updated 2026-08-15. Written to be read once rather than skipped, so it
...
<p>Three separate kinds of thing, sold as four products. It is worth keeping them apart.</p>
<p>The command line tool is MIT licensed and free. You can read it, fork it, run it on anything you
  have the right to read. Nothing about that depends on paying us. The five static checks are
...
<p><b>Fix flow</b> and <b>Solo Fix</b> are not software, they are work. Fix flow is 79 USD a month
  for up to three findings fixed, Solo Fix is 19 USD a month for one. Taking the larger of the two,
  we fix up to three findings you send us, each returned as a patch carrying a test that fails before
...
<p>There is no uptime commitment on the site. There does not need to be one. The site exists to sign
  you in, take a payment, hand you a licence and prepare a request you file yourself. Scanning happens on your machine, so an
