...
<section class="phead"><div class="wrap">
  ...
  <p class="lede prose">Watch is $8.99 a month for one owner's repositories. Team is $29 a month for
    an organisation. Fix flow is $79 a month if you would rather the findings arrived already
    fixed. The four static checks stay free with no account, no licence and no network.</p>
</div></section>
...
<section id="fixflow"><div class="wrap">
  ...
  <div class="tiers">
    <div class="tier pick">
      ...
      <p class="sm">No trial on this one, because a trial on a service is unpaid work.</p>
    </div>
    <div>
      ...
      <p class="prose">You send the finding, which already carries the file, the line, the rule that
        ...
        it does for the free scan: your code stays where it is.</p>
      <p class="prose">If a fix genuinely cannot be written from the finding alone, we say so and it
        does not count against your three. A patch that does not apply is our defect rather than
        your problem.</p>
      <p class="sm prose">This is the honest shape of it: the scan is a tool, the fix is a person
        writing a patch. Three a month is what one person can do properly, so that is the number on
        the page rather than the word unlimited.</p>
    </div>
  </div>
</div></section>
...
<section><div class="wrap">
  ...
  <table class="st">
    <tr><th>Price</th><td>Watch 8.99 USD a month for one repository owner. Team 29 USD a month for
      an organisation. Fix flow 79 USD a month for up to three fixed findings. No per seat and no
      per committer billing anywhere: a CI gate has no seats, so charging for engineers who never
      open the tool would be charging for nothing.</td></tr>
    <tr><th>Trial</th><td>Three days at no charge on Watch and Team. Fix flow has none, because a
      trial on a service is unpaid work.</td></tr>
